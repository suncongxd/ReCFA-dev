#define NGX_CONFIGURE " --with-cc=gcc --with-cc-opt='-O0 -mno-avx -fno-stack-protector -no-pie' --with-pcre=/home/suncong/repos/rrcfa-dev/lib/pcre-8.43 --with-pcre-opt='-g -O0 -mno-avx -fno-stack-protector -no-pie' --with-zlib=/home/suncong/repos/rrcfa-dev/lib/zlib-1.2.11 --with-zlib-opt='-g -O0 -mno-avx -fno-stack-protector -no-pie'"
